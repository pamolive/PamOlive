...
urlpatterns = [
    ...
    path("system/security-policy/", views.security_policy, name="security_policy"),
    path("system/siem/", views.siem_integrations, name="siem_integrations"),
    path("system/siem/<uuid:pk>/", views.siem_integrations, name="siem_integration_edit"),
