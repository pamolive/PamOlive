...
PAMOLIVE_KEYRING_URL = env("PAMOLIVE_KEYRING_URL", default="https://keyring:8000")
...
PAMOLIVE_KEYRING_TLS_CA_PATH = env(
    "PAMOLIVE_KEYRING_TLS_CA_PATH", default="/run/keyring-tls/ca.crt"
)
PAMOLIVE_KEYRING_TLS_CLIENT_CERT_PATH = env(
    "PAMOLIVE_KEYRING_TLS_CLIENT_CERT_PATH", default="/run/keyring-tls/client.crt"
)
PAMOLIVE_KEYRING_TLS_CLIENT_KEY_PATH = env(
    "PAMOLIVE_KEYRING_TLS_CLIENT_KEY_PATH", default="/run/keyring-tls/client.key"
)
PAMOLIVE_OUTBOUND_ALLOWED_CIDRS = env.list("PAMOLIVE_OUTBOUND_ALLOWED_CIDRS", default=[])
...
PAMOLIVE_MFA_STEP_UP_MAX_AGE_SECONDS = env.int("PAMOLIVE_MFA_STEP_UP_MAX_AGE_SECONDS", default=300)
